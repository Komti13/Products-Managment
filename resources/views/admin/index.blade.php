...
<header class="header_area">
    ...
    <div class="sidebar_logo">
        <a href="index.html">
            <img src="{{asset('images/logo.png')}}" alt="" class="img-fluid logo1 w-75">
            <img src="{{asset('images/favicon.png')}}" alt="" class="img-fluid logo2">
        </a>
    </div>
    ...
    <ul class="header_menu">
            ...
            <div class="dropdown_wrapper messages_item dropdown-menu dropdown-menu-right">
                ...
                <ul class="dropdown_body nice_scroll scrollbar">
                    <li>
                        <a href="#">
                            <div class="img-part">
                                <img src="{{asset('images/user1.jpg')}}" alt="" class="img-fluid">
                            </div>
                            <div class="text-part">
                    ...
                    <li>
                        <a href="#">
                            <div class="img-part">
                                <img src="{{asset('images/user2.jpg')}}" alt="" class="img-fluid">
                            </div>
                            <div class="text-part">
                    ...
                    <li>
                        <a href="#">
                            <div class="img-part">
                                <img src="{{asset('images/user3.jpg')}}" alt="" class="img-fluid">
                            </div>
                            <div class="text-part">
        ...
        <li><a data-toggle="dropdown" href="#"><i class="far fa-user"></i></a>
            <div class="user_item dropdown-menu dropdown-menu-right">
                <div class="admin">
                    <a href="#" class="user_link"><img src="{{asset('images/admin.jpg')}}" alt=""></a>
                </div>
                <ul>
        ...
        <section class="table_area">
            <div class="panel">
                <div class="panel_header">
                    <div class="panel_title"><span>FooTable with row toggler, sorting, filter and pagination test</span></div>
                </div>
